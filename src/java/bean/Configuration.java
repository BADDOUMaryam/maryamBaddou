...
public class Configuration implements Serializable {
    ...
    private int delai ;
    @ManyToOne
    private Avertissemnt  avertissemnt;
    ...
    public Avertissemnt getAvertissemnt() {
        return avertissemnt;
    }

    public void setAvertissemnt(Avertissemnt avertissemnt) {
        this.avertissemnt = avertissemnt;
    }
